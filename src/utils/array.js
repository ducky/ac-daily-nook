...
export const insertAt = (arr = [], item = {}, index = -1) => {
  return index > -1 ? [...arr.slice(0, index + 1), item, ...arr.slice(index + 1)] : [...arr, item];
};
...
// Non Object Based
export const toggleItem = (arr = [], value) => {
  const index = arr.indexOf(value);
  console.log(arr, [value], xor(arr, [value]));
  return index > -1 ? [...arr, value] : xor(arr, [value]);
};
